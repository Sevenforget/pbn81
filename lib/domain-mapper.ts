...
// 이 프로젝트(pbn1)의 도메인 정보를 하드코딩
const PROJECT_DOMAIN = "https://bizscalepro.com";
const PROJECT_NAME = "pbn1";
...
function loadDomainMappings(): DomainMapping[] {
  ...
  try {
    ...
    if (!fs.existsSync(jsonPath)) {
      console.warn(
        "pbn-domains.json 파일을 찾을 수 없습니다. 하드코딩된 값을 사용합니다."
      );
      return [];
    }
